...
PM_START_TEXT = """
`Hellow` [🐲](https://telegra.ph/file/a633cd9e817e64eea540d.jpg) `My name is` *Mansiezz*
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD NAGA-ROBOT TO YOUR GROUP ➕️", url="t.me/ilham270_bot?startgroup=true"),
    ],
    [
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ℹ️ I'm *NAGA-ROBOT*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [🐲Pembuat](https://t.me/diemmmmmmmmmm).
                 \n\nIf you have any question about Mansiezz, let us know at @diemmmmmmmmmm.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🐲 I'm *NAGA-ROBOT*
                 \nHere is the [Penulis](http://t.me/diemmmmmmmmmm) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Hallo Saya  online Ga rindu!")
        except Unauthorized:
            LOGGER.warning(
